"""Pydantic request/response schemas (the API's contract)."""
...
class UserResponsePublic(BaseModel):
    """Public user profile — never exposes the email address."""
...
class UserResponsePrivate(UserResponsePublic):
    """Internal variant of the public schema that includes email."""

...
# app.mount('/media',StaticFiles(directory="media"),name="media") # commented this line because we are removing the media directory because we are getting our files from AWS3 not this directory again   # Mounting files for media 
...
# changed router tags to Title case (Pascal case perhaps > )

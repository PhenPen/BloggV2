...
import models
from database import AsyncSessionLocal, database_engine
from image_utils import PROFILE_PICS_DIRECTORY
...
async def clear_existing_data() -> None:
    ...
    if PROFILE_PICS_DIRECTORY.exists():
        for file in PROFILE_PICS_DIRECTORY.iterdir():
            if file.is_file() and file.name != ".gitkeep":
                file.unlink()
        print(f"Deleted profile pictures from {PROFILE_PICS_DIRECTORY}")
